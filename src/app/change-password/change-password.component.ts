...
export class ChangePasswordComponent implements OnInit {
  ...
  updatepassword(){
    ...
    this.conf_new_password = document.getElementById('confnewpassword') as HTMLInputElement;
    if (this.old_password.value == '' || this.new_password.value == '' || this.conf_new_password.value == '') {
    ...
    else if (this.old_password && this.new_password && this.conf_new_password) {
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        if (json.ChangeUserPasswordData.StatusId == 1)
        {
          ...
          document.getElementById('warning').innerHTML =
          '<b><h2>' +
          json.ChangeUserPasswordData.Message +
          '</h2></b>';
